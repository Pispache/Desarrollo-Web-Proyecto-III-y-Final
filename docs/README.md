...
## Documentación Técnica
- [ADR de Reportes](./ADR-reports.md)
- [Notas de Despliegue](./deploy-notes.md)
- [Seguridad y Rutas](./security-routes.md)

## Seguridad y Autenticación
- OWASP / Seguridad: [security.md](./security.md)
- OAuth2.0 / Autenticación: [oauth2-implementation.md](./oauth2-implementation.md)
