-- DDL Postgres - Data Mart de Reportes
-- Tablas sincronizadas desde SQL Server
...
-- Tabla game_roster_entries (para fase futura)
...
-- Tabla etl_state para checkpoints
...
-- Permisos
GRANT CONNECT ON DATABASE reportsdb TO report_ro;
...
GRANT CONNECT ON DATABASE reportsdb TO etl_writer;
